            ...
            >
              <Link href="skills">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="relative group overflow-hidden py-4 px-8 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-lg"
                >
